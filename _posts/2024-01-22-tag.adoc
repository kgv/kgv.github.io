= Результаты анализа stem:[TAG] нативной ткани семян *Lunaria rediviva* с использованием stem:[H_2SO_4]/stem:[MeOH]
:table-caption: TAG
...
* xref:2024-01-22/Сернокислый МеОН_ТАГ_1.csv[TAG_1.csv]
* xref:2024-01-22/Сернокислый МеОН_ТАГ_2.csv[TAG_2.csv]
* xref:2024-01-22/Сернокислый МеОН_ТАГ_3.csv[TAG_3.csv]
